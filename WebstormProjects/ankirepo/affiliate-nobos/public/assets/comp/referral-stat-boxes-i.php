              ...
              <a href="#" class="apro-link">
                <div class="row m-row--no-padding">
                  ...
                  <div class="col-md-8 col-sm-8 col-xl-8 col" style="border: 0px solid red;">
                    <div class="apro_text">
                      <h2><?php total_referrals_period_i($start_date, $end_date, $owner);?></h2>
             ...
             <div class="m-widget24__item">
              <a href="#" class="apro-link">
                <div class="row m-row--no-padding">
                  ...
                  <div class="col-md-8 col-sm-8 col-xl-8 col">
                    <div class="apro_text">
                      <h2><?php my_conversion_period_i($start_date, $end_date, $owner);?></h2>
                      <h4><?php echo $lang['CONVERSION_RATE'];?> <span class="small-text">(selected period)</span></h4>
                    </div>
                  </div>
                </div>
              </a>
